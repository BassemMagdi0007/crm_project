      ...
      <div class="modal-dialog " role="document">
        ...
        <form action="{!!route('reply.store')!!}" method="POST">
          ...
          <div class="modal-footer justify-content-center">
            <button class="btn btn-outline-primary waves-effect w-25" data-dismiss="modal"><i class="fa fa-times"></i></button>
            <button type="submit" class="btn btn-primary waves-effect waves-light w-25"><i class="fa fa-paper-plane"></i></button>
          </div>
        </form>
        </div>
      </div>
